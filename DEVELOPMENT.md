...
```bash
git remote add encore encore://email-automation-app-b47i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/email-automation-app-b47i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/email-automation-app-b47i/settings/integrations/github)
